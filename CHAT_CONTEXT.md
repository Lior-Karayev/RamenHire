...
- All 9 DB migrations, including `job_listings`, `companies`, `rate_limit_hits`, the signed-upload-URL storage policy changes, and the 2026-07-08 legacy-policy fix
...
- Latest known production commit: `13714b4` ("fix: drop legacy anon-upload policy on cvs storage bucket"), on top of the large feature push in `c198ce7` ("feat: add company self-registration, rate limiting, legal pages, and signed upload URLs"). Verified live on ramenhire.com 2026-07-08.
